...
public class Test {
    private static final Graph<Integer, Double> testingGraph = new Graph<>();
    ...
    public static void testHasCustomer() {
        ...
        for (int i = 0; i < testingGraph.getSize(); i++) {
            ...
            System.out.print("Has MyGUI.delivery.Customer " + id + ": ");
    ...
    public static void testGetNeighbours() {
        ...
        for (int i = 0; i < testingGraph.getSize(); i++) {
            int id = testingGraph.getCustomerAt(i);
            System.out.print("Neighbours of MyGUI.delivery.Customer " + id + ": | ");
    ...
    public static void testRemoveEdge() {
        ...
        System.out.printf("Remove MyGUI.delivery.Edge from %d to %d\n", source, destination);
    ...
    public static void testGetDegree(int source, int destination) {
        System.out.println("getIndeg() of MyGUI.delivery.Customer " + source);
        System.out.println(testingGraph.getIndegOf(source));
        System.out.println("getOutdeg() of MyGUI.delivery.Customer " + source);
        System.out.println(testingGraph.getOutdegOf(source));
        System.out.println();
        System.out.println("getIndeg() of MyGUI.delivery.Customer " + destination);
        System.out.println(testingGraph.getIndegOf(destination));
        System.out.println("getOutdeg() of MyGUI.delivery.Customer " + destination);
    ...
    public void testGetIndexOf() {
        ...
        System.out.println("Index of MyGUI.delivery.Customer '1': " + testingGraph.getIndexOf(1));
        System.out.println();
    }
    ...
    public void testGetCustomerAt() {
        ...
        for (int i = 0; i < testingGraph.getSize(); i++) {
            System.out.println("MyGUI.delivery.Customer at index "+ i + ": " + testingGraph.getCustomerAt(i));
        }
        System.out.println();
    }
